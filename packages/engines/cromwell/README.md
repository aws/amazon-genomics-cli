...
An AWS-friendly mirror of Cromwell.

### Patching

Cromwell doesn't play too nicely with AWS. We have developed fixes, but they have not been merged into Cromwell.
Until then, we are patching the changes into the branch.
