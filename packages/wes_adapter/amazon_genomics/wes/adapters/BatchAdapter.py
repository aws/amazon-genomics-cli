...
class BatchAdapter(AbstractWESAdapter):
    ...
    def run_workflow(
        ...
        """
        E.g. [{ "name": "k1", "value": { "k2": 15 } }, { "name": "k3", "value": 10 }]
        """
        if os.environ.get("CUSTOM_WORKFLOW_JOB_ENVIRONMENTS") is not None:
            custom_environments = os.environ.get("CUSTOM_WORKFLOW_JOB_ENVIRONMENTS")
