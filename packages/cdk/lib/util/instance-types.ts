...
export const optimalInstanceTypes: { [key: string]: string[] } = {
  ["ON_DEMAND"]: [
    "c5.large",
    "c5.xlarge",
    "c5.2xlarge",
...
export const getInstanceTypesForBatch = (instanceTypes: InstanceType[] | undefined, computeType: string, region?: string): InstanceType[] => {
