...
const (
	...
	accountAdapterCustomEnvsFlag = "adapterCustomEnvs"
...
type accountActivateVars struct {
	...
	adapterCustomEnvs map[string]string
}
...
func (o accountActivateOpts) generateEnvVars() ([]string, error) {
	...
	if o.adapterCustomEnvs != nil {
		jsonBytes, err := json.Marshal(o.adapterCustomEnvs)
		if err != nil {
			return nil, err
		}
		environmentVars = append(environmentVars, fmt.Sprintf("%s=%s", constants.AdapterCustomEnvEnvKey, string(jsonBytes)))
	}
...
/code $ agc account activate --bucket my-custom-bucket --vpc my-vpc-id`,
	...
	cmd.Flags().StringToStringVar(&vars.adapterCustomEnvs, accountAdapterCustomEnvsFlag, nil, adapterCustomEnvsDescription)
	return cmd
}
