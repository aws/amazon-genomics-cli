...
const (
	...
	amiFlag                      = "ami"
	endpointTypeFlag             = "endpointType"
	endpointIdFlag               = "endpointId"
...
The endpoint must already exist in that VPC.`
	...
	RegionalEndpointType = "REGIONAL"
	PrivateEndpointType  = "PRIVATE"
)
...
func (o accountActivateOpts) generateEnvVars() ([]string, error) {
	...
	environmentVars := []string{
		...
		fmt.Sprintf("%s=%s", constants.AgcEndpointTypeEnvKey, o.endpointType),
		fmt.Sprintf("%s=%s", constants.AgcEndpointIdEnvKey, o.endpointId),
	}
...
func (o *accountActivateOpts) validate() error {
	...
	if o.endpointType != RegionalEndpointType && o.endpointType != PrivateEndpointType {
		return o.generateValidationError(fmt.Errorf("invalid endpointType '%s', endpointType must be one of %s or %s", o.endpointType, RegionalEndpointType, PrivateEndpointType),
...
/code $ agc account activate --bucket my-custom-bucket --vpc my-vpc-id`,
	...
	cmd.Flags().StringVar(&vars.endpointType, endpointTypeFlag, RegionalEndpointType, endPointTypeFlagDescription)
	cmd.Flags().StringVar(&vars.endpointId, endpointIdFlag, "", endpointIdFlagDescription)
	return cmd
}
