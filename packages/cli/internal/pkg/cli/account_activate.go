...
const (
	...
	accountVpcFlag               = "vpc"
	skipBootstrapFlag            = "skip-bootstrap"
...
A new VPC will be created if not specified.`
	skipBootstrapFlagDescription = `Account activation will skip CDK Bootstrapping`
...
/code $ agc account activate --bucket my-custom-bucket --vpc my-vpc-id`,
	...
	cmd.Flags().BoolVar(&vars.skipBootstrap, skipBootstrapFlag, false, skipBootstrapFlagDescription)
	return cmd
}
