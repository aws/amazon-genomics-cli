...
Activating an account will also bootstrap the AWS Environment for CDK app deployments. You can skip [CDK Bootstrapping](https://docs.aws.amazon.com/cdk/latest/guide/bootstrapping.html) with the `--skip-bootstrap` flag
