...
ECR_MINIWDL_ACCOUNT_ID="555741984805"
ECR_MINIWDL_REGION="us-east-1"
export ECR_MINIWDL_ACCOUNT_ID ECR_MINIWDL_REGION
...
ECR_MINIWDL_TAG=$(get_latest_version "$MINIWDL_REPOSITORY" "$ECR_MINIWDL_ACCOUNT_ID" "$ECR_MINIWDL_REGION")

export ECR_WES_TAG ECR_CROMWELL_TAG ECR_NEXTFLOW_TAG ECR_MINIWDL_TAG
